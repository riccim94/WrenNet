    ...
    if load_pregenerated:
        ...
        if num_empty_target > 0:
            ...
            empty_segment_base = EmptySegmentDataset(
                ...
                seed=current_seed,
                cache_path=empty_segment_cache_path,
                refresh_cache=refresh_empty_segment_cache,
            )
...
def create_combined_dataset(bird_data_dir, esc50_dir, allowed_bird_classes=None,
    ...
    Args:
        ...
        empty_segment_cache_path (str): Optional JSON file to cache empty segment metadata
        refresh_empty_segment_cache (bool): Force rebuilding the cache even if it exists
    ...
    no_birds_dataset = create_no_birds_dataset(
        ...
        empty_segment_cache_path=empty_segment_cache_path,
        refresh_empty_segment_cache=refresh_empty_segment_cache,
    )
